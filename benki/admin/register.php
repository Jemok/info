...
if(isset($_POST['btn-signup']))
{
	...
	$res= mysql_query("INSERT INTO tbl_users(user_id,full_names,phone_no,role,email,password) VALUES('$user_id','$full_names','$phone_no','1','$email','$pass')") or die(mysql_error());
...
<body style="background: #fff url(img/bg-1.jpg) no-repeat center fixed">
<center>
<div id="login-form">
<form method="post" >
<table align="center" width="30%" border="0" style="background: rgba(255,255,255,0.7)">
<tr>
...
<tr>
<td><a href="http://localhost/benki/admin/index.php">Sign In Here</a></td>
</tr>
</table>
</form>
</div>
